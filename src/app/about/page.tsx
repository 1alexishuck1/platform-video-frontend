// About / Presentation Page (Old Home)
...
async function getTalents(): Promise<TalentProfile[]> {
  try {
    const apiUrl = `${process.env.NEXT_PUBLIC_API_URL || "http://localhost:4000/api"}/talents`;
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        ...
        <section className="pt-24 pb-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              Explorar talentos <ArrowRight className="w-4 h-4" />
            </Link>
            <Link 
